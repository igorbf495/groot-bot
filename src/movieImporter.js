...
export async function startMovieImport({ url, title, notify }) {
    ...
    activeJob = { title: cleanTitle, url: publicUrl, notify, finalPath, downloadPath, phase: 'iniciando', detail: '', child: null, cancelled: false, startedAt: Date.now(), finishedAt: null, error: null };
